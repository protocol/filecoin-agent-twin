...
def generate_sdm_experiments(output_fp):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--experiment', type=str, default='sdm', 
                        choices=['sdm', 'miner_proportion_network_sensitivity'])
    parser.add_argument('--output_fp', type=str, default='sdm_experiments.txt')
    
    args = parser.parse_args()
    output_fp = args.output_fp

    if args.experiment == 'sdm':
        generate_sdm_experiments(output_fp)
    elif args.experiment == 'miner_proportion_network_sensitivity':
